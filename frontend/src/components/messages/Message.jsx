const Message = () => {
	return (
		<div className='chat chat-end'>
			...
			<div className={`chat-bubble text-white bg-blue-500`}>Hi! are you free right now?</div>
			<div className='chat-footer opacity-50 text-xs flex gap-1 items-center'>01:21</div>
		</div>
	);
};
